...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/login/logout"
                ...
                ,"/personPosition/**"
                ,"/plat/**"
                ,"/bleterminal/findBleTerminalContainStatus1"
                ,"/bikedetail/findBleBikeDetailInfo1"
                ,"/hisstatistic/findBleCheckCompanyAbandonAnalysisResult1"
                ,"/hisstatistic/findBleCheckCompanyNumList1"
                ,"/countJieZhen/getAreaPointMsg1"
                ,"/count/bikeCompany1"
                ,"/blestatics/staticsBleCheckNum1"
                ,"/exportData/**"
        );
        super.configure(web);
    }
