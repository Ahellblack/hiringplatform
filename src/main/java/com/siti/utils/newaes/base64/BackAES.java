...
public class BackAES {
	...
	private static String aesKey = "siti@itsbikes";
...
/********************************方法一，密匙必须为16位**********************************************/
	// 加密
	public static byte[] encrypt(String sSrc, int type)
			throws Exception {
		String sKey=toMakekey(aesKey, pwdLenght, val);
	...
	// 解密
	public static String decrypt(String sSrc, int type)
			throws Exception {
		String	sKey=toMakekey(aesKey, pwdLenght, val);
		try {
